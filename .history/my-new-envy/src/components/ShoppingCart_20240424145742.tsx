...
const ShoppingCart: React.FC = () => {
  ...
  // Display the cart contents and heading when items are present
  return (
    <div>
      <h2>Your Cart</h2>  // This now only shows when there are items in the cart
