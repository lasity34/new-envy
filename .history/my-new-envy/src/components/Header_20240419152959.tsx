...
const NavLink = styled.li`
  position: relative;
  margin-left: 20px;
  overflow: hidden; // Ensure the pseudo-element does not show when width is zero
  ...
  a {
    ...
    &::after {
      ...
      transition: width 0.5s ease; // Slow down the transition
    ...
    &:hover {
      ...
      &::after {
        ...
        transform: translateX(0%); // Reset translation to fill the width
      }
    }
  }
`;
