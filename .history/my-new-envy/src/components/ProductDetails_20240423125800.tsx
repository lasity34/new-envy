...
const QuantityContainer = styled.div`
  ...
  align-items: center;
  margin-top: 20px;
  border: 1px solid #333; // Add a subtle border around the entire container
...
const QuantityButton = styled.button`
  ...
  &:hover {
    background-color: #e2e2e2; // Light grey background on hover for visual feedback
  }
`;
...
const QuantityInput = styled.input`
  ...
  &:focus {
    border-color: #007bff; // Use a distinct color for focus
  }
`;
